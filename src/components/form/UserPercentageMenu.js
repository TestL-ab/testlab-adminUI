    ...
    <div className="pt-5 w-40">
      <Combobox as="div" value={percentageObj} onChange={setPercentageObj}>
        ...
        <div className="relative mt-2">
          <Combobox.Input
            className="w-full rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-testLabBlue sm:text-sm sm:leading-6"
                ...
                <Combobox.Option
                  ...
                  className={({ active }) =>
                    classNames(
                      ...
                      active ? 'bg-testLabBlue text-white' : 'text-gray-900'
                    )
                  }
                >
                  {({ active, selected }) => (
                      ...
                      {selected && (
                        <span
                          className={classNames(
                            ...
                            active ? 'text-white' : 'text-testLabBlue'
                          )}
                        >
