    ...
    <div className="sm:col-span-5">
      ...
      <div className="mt-2 flex rounded-md shadow-sm sm:col-span-5">
        <input
          ...
          name="name"
          id="name"
          className="block w-full min-w-0 flex-1 rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-testLabBlue sm:text-sm sm:leading-6 sm:py-1.5"
          value={name}
