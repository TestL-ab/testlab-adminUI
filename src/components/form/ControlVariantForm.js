      ...
      <div className="sm:col-span-3">
        ...
        <div className="mt-2">
          <input
            ...
            name="value-1"
            id="value-1"
            className="block w-full rounded-md border-0 px-1.5 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-testLabBlue sm:text-sm sm:leading-6"
        ...
        {!upcomingExperiment &&
          <div className="sm:col-span-3">
            ...
            <p className="mt-1 text-sm font-medium text-gray-500">{Math.floor(variantObj.weight)}%</p>
          </div>
        }
      </div>
    </div>
