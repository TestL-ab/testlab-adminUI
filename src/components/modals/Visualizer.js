        ...
        <>
          <div className="overflow-hidden bg-white shadow sm:rounded-lg ">
            <div className="px-4 py-5 sm:px-6 ">
              ...
              <p className="mt-1 italic tracking-tight max-w-2xl text-descr text-gray-500">Experiment Description: {experiment.description}</p>
              {/* <p>&nbsp;</p> */}
              <p className="pt-2 mt-1 max-w-2xl text-xs text-testLabDarkBlue">For more information on interpreting this data</p>
            </div>
