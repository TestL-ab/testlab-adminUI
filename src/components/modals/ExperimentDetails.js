                      ...
                      <div className="flex w-full items-center justify-between space-x-6 p-6">
                        <div className="flex-1 truncate">
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <h2 className="text-s font-bold break-normal text-gray-900">{controlVariant.value}</h2>
                          </div>
                          <span className="inline-block flex-shrink-0 rounded-full bg-green-100 px-2 py-0.5 text-xs font-medium text-green-800">
                            ...
                            <br/>
                            <br/>
                          <p className="mt-1 truncate text-sm text-gray-500">{controlVariant.weight * 100}% of users in experiment</p>
                    ...
                    {otherVariants.map((variant) => (
                      <li key={variant.id} className="col-span-1 divide-y divide-gray-200 rounded-lg bg-white shadow">
                        <div className="flex w-full items-center justify-between space-x-6 p-6">
                          <div className="flex-1 truncate">
                            <div className="flex items-center space-x-3">
                              <h3 className="text-s font-bold text-gray-900">{variant.value}</h3>
                            </div>
                            <br/>

                            <br/>
                            <p className="mt-1 truncate text-sm text-gray-500">{variant.weight * 100}% of users in experiment</p>
                          </div>
                        </div>
                      </li>
                    ))}
